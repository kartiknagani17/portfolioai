...
export default function TemplateTheAtlas({ portfolioData }: { portfolioData: PortfolioData }) {
  const {
    personal,
    experience,
    projects,
  ...
  return (
    <>
      <style>{`
        ...
        .ta-hero-bottom{
          display:grid;grid-template-columns:1fr auto 1fr;gap:40px;align-items:start;width:100%;
        ...
        .ta-hero-bio{font-size:clamp(14px,1.4vw,16px);color:var(--ta-dim);line-height:1.85;text-align:left;}
        .ta-hero-cta{display:flex;flex-direction:column;align-items:center;gap:10px;flex-shrink:0;}
        .ta-hero-cta-btn{
          font-family:'IBM Plex Mono',monospace;font-size:10px;
        ...
        .ta-hero-meta{display:flex;flex-direction:column;align-items:flex-end;gap:10px;}
        .ta-hero-meta-item{font-family:'IBM Plex Mono',monospace;font-size:11px;letter-spacing:0.08em;color:var(--ta-dim);display:flex;align-items:center;gap:8px;}
        .ta-meta-dot{
          ...
          <div className="ta-hero-center">
            ...
            <div className="ta-hero-bottom" id="ta-hero-bottom">
              ...
              <div className="ta-hero-meta">
                {personal.location && <div className="ta-hero-meta-item">{personal.location.toLowerCase()}</div>}
                {personal.email && <div className="ta-hero-meta-item">{personal.email}</div>}
              </div>
            </div>
          </div>
        </section>
                  ...
                  <div>
                    ...
                    {proj.techStack.length > 0 && (
                      <div className="ta-proj-chips">
                        {proj.techStack.map((t, ti) => <span className="ta-proj-chip" key={ti}>{t}</span>)}
                      </div>
                    )}
...
function TAEffects({
  ...
  useEffect(() => {
    ...
    document.getElementById("ta-tagline") && taglineObs.observe(document.getElementById("ta-tagline")!)
