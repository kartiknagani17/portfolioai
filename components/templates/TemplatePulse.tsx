...
export default function TemplatePulse({ portfolioData: data }: { portfolioData: PortfolioData }) {
  const {
    personal,
    experience,
    projects,
  ...
  const workStylePrinciples: { heading: string; body: string }[] | undefined = undefined
  ...
  const css = `
    ...
    .tp-lf-in { position: relative; z-index: 1; max-width: 1100px; width: 100%; }
    ...
    .tp-lf-text { font-family: var(--sy); font-size: clamp(15px,1.4vw,18px); font-weight: 400; letter-spacing: -.01em; color: rgba(248,249,251,.75); line-height: 1.85; margin-bottom: 48px; columns: 2; column-gap: 56px; }
    @media (max-width: 760px) { .tp-lf-text { columns: 1; } }
